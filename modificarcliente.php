            ...
            <li class="nav-item active">
                ...
                <div id="collapsePages" class="collapse show" aria-labelledby="headingPages"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="cargarfamilias.php">Familia</a>
                        <a class="collapse-item" href="cargarcategorias.php">Categoria</a>
                        <a class="collapse-item" href="cargarproveedores.php">Proveedor</a>
                        <a class="collapse-item" href="cargarclientes.php">Cliente</a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Modulo de Modificacion Cliente</h1>
                    <hr>
                    <div>       
                        <div>
                            <?php
                            ...
                            <form action="" method="post">
                                ...
                                Ingrese Nombre <br>
                                <input type="text" name="txtNom" value="<?=$fila[1]?>"class="form-control"> <br>
                                Ingrese Apellidos <br>
                                <input type="text" name="txtApe" value="<?=$fila[2]?>"class="form-control"> <br>
                                Ingrese dni <br>
                                <input type="text" name="txtDni" value="<?=$fila[3]?>"class="form-control"> <br>
                                Ingrese Celular <br>
                                <input type="text" name="txtCel" value="<?=$fila[4]?>"class="form-control"> <br>
                                Ingrese Direccion <br>
                                <input type="text" name="txtDir" value="<?=$fila[5]?>"class="form-control"> <br>
