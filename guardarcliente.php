        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Modulo de Insercion Cliente</h1>
                    <hr>
                    <div>
                        <div>
                            ...
                            <div>
                                <form action="" method="post">
                                    ...
                                    <input type="text" name="txtApe"class="form-control"> <br>
                                    Ingrese dni <br>
                                    <input type="text" name="txtDni"class="form-control"> <br>
                                    Ingrese Celular <br>
                                    <input type="text" name="txtCel"class="form-control"> <br>
